...
export default {
    ...
    setup() {
        ...
        const getTodos = async (page = currentPage.value) => {
            ...
            try {
                const res = await axios.get(`http://localhost:3000/todos?_sort=id&order=desc&subject_like=${searchText.value}&_page=${page}&_limit=${limit}`);
