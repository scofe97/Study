...
import com.example.chapter5_clean_arch.databinding.ActivityDetailBinding
...
internal class DetailActivity : BaseActivity<DetailViewModel>() {
    ...
    override fun observerData() = viewModel.toDoDetailLiveData.observe(this@DetailActivity){
        when (it) {
