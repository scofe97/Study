...
public class Problem_S5_17478 {
    ...
    static void recursive(int step, int end){
        String under = recursive2(0, step*4);
        if(step == end){
            ...
            recursive(step+1, end);
            System.out.println(under + "라고 답변하였지.");
        }
    }

    public static String recursive2(int step, int end){
        if(step == end){
            return "";
        }else{
            return "_" + recursive2(step+1, end);
        }
    }
}
