...
public class Chapter6_1 {
    public static void main(String[] args) {
        ...
        // chapter 6.3 그룹화
        // 음식 타입으로 그룹화
        Map<Dish.Type, List<Dish>> dishsByType = menu.stream()
        ...
        Map<Dish.Type, Set<String>> dishNamesByTypes = menu.stream()
                .collect(Collectors.groupingBy(dish -> dish.getType(),
                        Collectors.flatMapping(dish -> dishTags.getOrDefault(dish.getName(), Arrays.asList(""))
                                        .stream(),
                                Collectors.toSet())));
        ...
        Map<Dish.Type, Long> typesCount = menu.stream()
                .collect(Collectors.groupingBy(dish -> dish.getType(), Collectors.counting()));
